    ...
    <Sheet open={open} onOpenChange={handleClose}>
      <SheetContent side="bottom" className="h-[95vh] flex flex-col p-0 rounded-t-2xl">
        ...
        <SheetHeader className="p-4 pb-3 border-b sticky top-0 bg-background z-10">
          <SheetTitle className="text-lg sm:text-xl font-serif text-left">
          ...
          {step === "date" && (
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-muted-foreground mb-3">
                ...
                <span className="text-xs sm:text-sm font-medium">Sélectionnez une date</span>
              </div>
              ...
              {selectedDate && (
                <div className="text-center p-3 bg-primary/10 rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Date sélectionnée:</p>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2 text-muted-foreground">
                  ...
                  <span className="text-xs sm:text-sm font-medium">Sélectionnez un horaire</span>
                </div>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <div className="text-center p-2 bg-primary/10 rounded-lg mb-2">
                <p className="text-xs sm:text-sm font-semibold text-primary">
                  {format(selectedDate, "EEEE d MMMM yyyy", { locale: fr })}
                </p>
              </div>
              {/* Time slots - optimized grid, compact, no internal scroll */}
              <div className="grid grid-cols-3 gap-2">
                {TIME_SLOTS.map((time) => (
                  <Button
                    ...
                    className="h-9 sm:h-10 text-xs font-medium py-2"
                  >
                    {time}
                  </Button>
                ))}
              ...
              {selectedTime && (
                <div className="text-center p-2 bg-primary/10 rounded-lg mt-2">
                  <p className="text-xs text-muted-foreground mb-1">Horaire sélectionné:</p>
                  <p className="font-semibold text-primary text-sm sm:text-base">{selectedTime}</p>
                </div>
              )}
            </div>
          )}

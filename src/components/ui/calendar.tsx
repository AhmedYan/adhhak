  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center mb-4 px-12",
        caption_label: "text-base font-semibold text-center flex-1",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 bg-white border-2 border-primary/20 p-0 opacity-90 hover:opacity-100 hover:bg-primary/5 rounded-full shadow-md z-20"
        ),
